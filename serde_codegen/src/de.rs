...
fn deserialize_item_enum(
    ...
    let ignored_arm = if container_attrs.skip_deserializing_unknown() {
        // TODO: Is this right?
...
fn deserialize_field_visitor(
    ...
    let ignore_variant = if container_attrs.skip_deserializing_unknown() {
    ...
    let fallthrough_arm_expr = if container_attrs.skip_deserializing_unknown() {
